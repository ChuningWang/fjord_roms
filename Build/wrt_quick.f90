...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     GRID(ng) % z_r)
        IF (FoundError(status, nf90_noerr, 250,                         &
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     GRID(ng) % z_v)
        IF (FoundError(status, nf90_noerr, 281,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % ubar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 387,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % vbar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 410,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Ur2d)
        IF (FoundError(status, nf90_noerr, 453,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Vr2d)
        IF (FoundError(status, nf90_noerr, 470,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask_full,                       &
     &                     OCEAN(ng) % u(:,:,:,nrhs(ng)))
        IF (FoundError(status, nf90_noerr, 497,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % u(:,:,N(ng),nrhs(ng)))
        IF (FoundError(status, nf90_noerr, 543,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % v(:,:,N(ng),nrhs(ng)))
        IF (FoundError(status, nf90_noerr, 566,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                       GRID(ng) % rmask_full,                     &
     &                       Ur3d)
          IF (FoundError(status, nf90_noerr, 612,                       &
     &                   "ROMS/Utility/wrt_quick.F")) THEN
            IF (Master) THEN
     ...
     &                       GRID(ng) % rmask_full,                     &
     &                       Vr3d)
          IF (FoundError(status, nf90_noerr, 630,                       &
     &                   "ROMS/Utility/wrt_quick.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                       GRID(ng) % rmask_full,                     &
     &                       Vr3d(:,:,N(ng)))
          IF (FoundError(status, nf90_noerr, 673,                       &
     &                   "ROMS/Utility/wrt_quick.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     Wr3d)
        IF (FoundError(status, nf90_noerr, 708,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     OCEAN(ng) % wvel)
        IF (FoundError(status, nf90_noerr, 732,                         &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                       OCEAN(ng) % t(:,:,N(ng),nrhs(ng),itrc))
          IF (FoundError(status, nf90_noerr, 783,                       &
     &                   "ROMS/Utility/wrt_quick.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akv,                            &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1365,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,itemp),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1389,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1440,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1465,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % svstr)
        IF (FoundError(status, nf90_noerr, 1852,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % bustr)
        IF (FoundError(status, nf90_noerr, 1875,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % bvstr)
        IF (FoundError(status, nf90_noerr, 1898,                        &
     &                 "ROMS/Utility/wrt_quick.F")) THEN
          IF (Master) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 2863,                          &
     &               "ROMS/Utility/wrt_quick.F")) RETURN
