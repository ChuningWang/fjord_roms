...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     GRID(ng) % z_r)
        IF (FoundError(status, nf90_noerr, 269,                         &
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     GRID(ng) % z_v)
        IF (FoundError(status, nf90_noerr, 300,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % ubar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 449,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     OCEAN(ng) % vbar(:,:,kstp(ng)))
        IF (FoundError(status, nf90_noerr, 569,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Ur2d)
        IF (FoundError(status, nf90_noerr, 709,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Vr2d)
        IF (FoundError(status, nf90_noerr, 726,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Ur3d)
        IF (FoundError(status, nf90_noerr, 905,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     Vr3d)
        IF (FoundError(status, nf90_noerr, 922,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % rmask,                            &
     &                     Wr3d)
        IF (FoundError(status, nf90_noerr, 956,                         &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!----------------------------
     ...
     &                     GRID(ng) % rmask_full,                       &
     &                     OCEAN(ng) % rho)
        IF (FoundError(status, nf90_noerr, 1423,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,itemp),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1723,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     MIXING(ng) % Akt(:,:,:,isalt),               &
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1748,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     SetFillVal = .FALSE.)
        IF (FoundError(status, nf90_noerr, 1774,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                       FORCES(ng) % stflx(:,:,itrc))
          IF (FoundError(status, nf90_noerr, 3170,                      &
     &                   "ROMS/Utility/wrt_his.F")) THEN
            IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % sustr)
        IF (FoundError(status, nf90_noerr, 3368,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % vmask,                            &
     &                     FORCES(ng) % svstr)
        IF (FoundError(status, nf90_noerr, 3395,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
     ...
     &                     GRID(ng) % umask,                            &
     &                     FORCES(ng) % bustr)
        IF (FoundError(status, nf90_noerr, 3418,                        &
     &                 "ROMS/Utility/wrt_his.F")) THEN
          IF (Master) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 4406,                          &
     &               "ROMS/Utility/wrt_his.F")) RETURN
