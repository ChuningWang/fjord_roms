...
!
     ...
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 682,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
!  Define free-surface.
!
     ...
     &                 NF_FRST, nvd3, t2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 813,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd3, u2dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 865,                         &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, v3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 1025,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                   NF_FRST, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1088,                      &
     &                   "ROMS/Utility/def_rst.F")) RETURN
        END DO
!------------------------------------------
...
!
     ...
     &                 NF_FRST, nvd4, r3dgrd, Aval, Vinfo, ncname)
        IF (FoundError(exit_flag, NoError, 1284,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
     ...
     &                 NF_FRST, nvd4, w3dgrd, Aval, Vinfo, ncname,      &
     &                 SetFillVal = .FALSE.)
        IF (FoundError(exit_flag, NoError, 1501,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
!
...
!
        ...
        IF (FoundError(exit_flag, NoError, 2390,                        &
     &                 "ROMS/Utility/def_rst.F")) RETURN
      END IF DEFINE
!
!=======================================================================
