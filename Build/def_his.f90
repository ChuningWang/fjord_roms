...
!
     ...
     &                 nf90_unlimited, DimIDs(12))
        IF (FoundError(exit_flag, NoError, 285,                         &
     &                 "ROMS/Utility/def_his.F")) RETURN
        recdim=DimIDs(12)
!
...
!
     ...
     &                 SetParAccess = .FALSE.)
        IF (FoundError(exit_flag, NoError, 452,                         &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
...
!
     ...
     &                   NF_FOUT, nvd4, u3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 966,                       &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, v3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1020,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1075,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, t3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1095,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1115,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1134,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                 NF_FOUT, nvd3, t2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 1626,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname,    &
     &                   SetFillVal = .FALSE.)
          IF (FoundError(exit_flag, NoError, 1646,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname,    &
     &                   SetFillVal = .FALSE.)
          IF (FoundError(exit_flag, NoError, 1666,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname,    &
     &                   SetFillVal = .FALSE.)
          IF (FoundError(exit_flag, NoError, 1687,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd4, w3dgrd, Aval, Vinfo, ncname,    &
     &                   SetFillVal = .FALSE.)
          IF (FoundError(exit_flag, NoError, 1745,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, u2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2118,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
     ...
     &                   NF_FOUT, nvd3, v2dgrd, Aval, Vinfo, ncname)
          IF (FoundError(exit_flag, NoError, 2137,                      &
     &                   "ROMS/Utility/def_his.F")) RETURN
        END IF
!
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3819,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
        ...
        IF (FoundError(exit_flag, NoError, 3842,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
!  Inquire about the variables.
!
        CALL netcdf_inq_var (ng, iNLM, ncname)
        IF (FoundError(exit_flag, NoError, 3848,                        &
     &                 "ROMS/Utility/def_his.F")) RETURN
!
!  Open history file for read/write.
!
        CALL netcdf_open (ng, iNLM, ncname, 1, HIS(ng)%ncid)
        IF (FoundError(exit_flag, NoError, 3854,                        &
     &                 "ROMS/Utility/def_his.F")) THEN
