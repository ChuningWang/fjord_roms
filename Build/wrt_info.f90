...
!
     ...
     &                      Fbeta, (/0/), (/0/),                        &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 366,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
...
!
     ...
     &                      nl_visc2(ng), (/0/), (/0/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 440,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 514,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      Akv_bak(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 531,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      Akp_bak(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 544,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
!  Drag coefficients.
!
     ...
     &                      rdrg2(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 597,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      Zos(ng), (/0/), (/0/),                      &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 610,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      gls_c2(ng), (/0/), (/0/),                   &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 651,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'gls_c3m',               &
     &                      gls_c3m(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 657,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      gls_Kmin(ng), (/0/), (/0/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 681,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 693,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      sz_alpha(ng), (/0/), (/0/),                 &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 705,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'CrgBan_cw',             &
     &                      crgban_cw(ng), (/0/), (/0/),                &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 711,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 733,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
      DO itrc=1,NT(ng)
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 748,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                        FSobc_out(ng,:), (/1/), (/4/),            &
     &                        ncid = ncid)
        IF (FoundError(exit_flag, NoError, 773,                         &
     &                 "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                        Tobc, (/1,1/), (/NT(ng),4/),              &
     &                        ncid = ncid)
        IF (FoundError(exit_flag, NoError, 797,                         &
     &                 "ROMS/Utility/wrt_info.F")) RETURN
        DO ibry=1,4
          DO itrc=1,NT(ng)
     ...
     &                        M3obc_in(ng,:), (/1/), (/4/),             &
     &                        ncid = ncid)
        IF (FoundError(exit_flag, NoError, 814,                         &
     &                 "ROMS/Utility/wrt_info.F")) RETURN
        CALL netcdf_put_fvar (ng, model, ncname, 'M3obc_out',           &
     &                        M3obc_out(ng,:), (/1/), (/4/),            &
     &                      ncid = ncid)
        IF (FoundError(exit_flag, NoError, 820,                         &
     &                 "ROMS/Utility/wrt_info.F")) RETURN
      END IF
!
...
!
     ...
     &                      rho0, (/0/), (/0/),                         &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 831,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 912,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      LsshCLM(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 921,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 940,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 962,                           &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
!-----------------------------------------------------------------------
...
!
     ...
     &                      spherical, (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 1490,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
!  Domain Length.
!
...
!
     ...
     &                      theta_s(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 1526,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'theta_b',               &
     &                      theta_b(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 1532,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
...
!
     ...
     &                      (/1/), (/0/), (/0/),                        &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 1554,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, 1582,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
...
!
     ...
     &                           GRID(ng) % h,                          &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 1635,                  &
...
!
     ...
     &                           GRID(ng) % f,                          &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 1705,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % lonr,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1785,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % latr,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1823,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % xr,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1863,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % yr,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1901,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % lonu,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1943,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % latu,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1968,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % xu,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 1995,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % yu,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2020,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % latv,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2074,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % xv,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2101,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % yv,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2126,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % lonp,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2155,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % latp,                     &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2180,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                             GRID(ng) % xp,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2207,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                             GRID(ng) % yp,                       &
     &                             SetFillVal = .FALSE.)
                IF (FoundError(status, nf90_noerr, 2232,                &
     &                         "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                           GRID(ng) % rmask,                      &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 2303,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                           GRID(ng) % umask,                      &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 2326,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                           GRID(ng) % vmask,                      &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 2349,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
     ...
     &                           GRID(ng) % pmask,                      &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 2372,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
...
!
     ...
     &                           GRID(ng) % rdrag,                      &
     &                           SetFillVal = .FALSE.)
              IF (FoundError(status, nf90_noerr, 2509,                  &
     &                       "ROMS/Utility/wrt_info.F")) THEN
...
!
      ...
      IF (FoundError(exit_flag, NoError, 2558,                          &
     &               "ROMS/Utility/wrt_info.F")) RETURN
!
