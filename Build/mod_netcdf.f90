...
!
     ...
     &                                      TRIM(ncname)
          ...
          CASE ('Vstretching')
            CALL netcdf_get_ivar (ng, IDmod, ncname, var_name(i),       &
     &                            IvarS)
            IF (FoundError(exit_flag, NoError, 685,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_check_var")) RETURN
     ...
     &                                      TRIM(ncname)
          ...
          CASE ('Tcline')
            CALL netcdf_get_fvar (ng, IDmod, ncname, var_name(i),       &
     &                            FvarS)
            IF (FoundError(exit_flag, NoError, 737,                     &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_check_var")) RETURN
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 1243,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     ...
     &                          TRIM(SourceFile)
        ...
        ELSE
          IF (n_var.gt.Mvars) THEN
            ...
            exit_flag=2
          END IF
          IF (FoundError(status, nf90_noerr, 1302,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_inq_var")) THEN
...
!
     ...
     &                                      var_Dname(i), var_Dsize(i))
              IF (FoundError(status, nf90_noerr, 1388,                  &
     &                       "ROMS/Modules/mod_netcdf.F" //             &
     &                       ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Aint(i))
                      IF (FoundError(status, nf90_noerr, 1413,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    var_Afloat(i))
                      IF (FoundError(status, nf90_noerr, 1432,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
     ...
     &                                    TRIM(var_Aname(i)),           &
     &                                    text(1:my_Alen))
                      IF (FoundError(status, nf90_noerr, 1449,          &
     &                               "ROMS/Modules/mod_netcdf.F" //     &
     &                               ", netcdf_inq_var")) THEN
...
!
      IF (InpThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 1606,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
     ...
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 1736,              &
     &                           "ROMS/Modules/mod_netcdf.F" //         &
            ...
            IF (status.eq.nf90_noerr) THEN
              DO i=1,nvatts
                IF (TRIM(my_Aname).eq.TRIM(AttName(i))) THEN
                  status=nf90_get_att(my_ncid, varid, TRIM(AttName(i)), &
     &                                AttValue(i))
                  IF (FoundError(status, nf90_noerr, 1920,              &
     &                           "ROMS/Modules/mod_netcdf.F" //         &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2078,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 2096,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2251,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2268,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2481,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2498,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2715,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2732,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 2960,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_fvar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 2977,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
     ...
     &                                 xtype = my_type)
          IF (status.eq.nf90_noerr) THEN
            ...
            ELSE IF (my_type.eq.nf90_char) THEN
              ...
              END IF
            END IF
            IF (FoundError(status, nf90_noerr, 3231,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3554,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3672,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3689,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3808,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_ivar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3825,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 3942,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 3959,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 0, my_ncid)
        IF (FoundError(exit_flag, NoError, 4077,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_get_svar")) RETURN
      ELSE
        my_ncid=ncid
      ...
      IF (InpThread) THEN
        ...
        IF (status.eq.nf90_noerr) THEN
          ...
          ELSE
            status=nf90_get_var(my_ncid, varid, A)
          END IF
          IF (FoundError(status, nf90_noerr, 4094,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_get_svar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        ...
        IF (FoundError(exit_flag, NoError, 4212,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          ...
          IF (FoundError(status, nf90_noerr, 4224,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 4246,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4355,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4367,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 4384,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4493,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4505,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4522,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4631,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4643,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4660,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4769,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_fvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4781,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 4798,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_fvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 4909,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 4921,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          ELSE
            ...
            status=nf90_put_var(my_ncid, my_varid, my_A, start, total)
          END IF
          IF (FoundError(status, nf90_noerr, 4943,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5052,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5064,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 5081,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5190,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_ivar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5202,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, A, start, total)
          IF (FoundError(status, nf90_noerr, 5219,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_ivar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5334,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5346,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          END IF
          IF (FoundError(status, nf90_noerr, 5377,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5491,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5503,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5531,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5645,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_put_lvar")) RETURN
      ELSE
        my_ncid=ncid
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5657,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,10) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          status=nf90_put_var(my_ncid, my_varid, AI, start, total)
          IF (FoundError(status, nf90_noerr, 5687,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_lvar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
      IF (.not.PRESENT(ncid)) THEN
        CALL netcdf_open (ng, model, TRIM(ncname), 1, my_ncid)
        IF (FoundError(exit_flag, NoError, 5797,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
...
!
      IF (OutThread) THEN
        IF (.not.PRESENT(varid)) THEN
          status=nf90_inq_varid(my_ncid, TRIM(myVarName), my_varid)
          IF (FoundError(status, nf90_noerr, 5809,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 5828,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          mytotal(2)=total(1)
          status=nf90_put_var(my_ncid, my_varid, A, mystart, mytotal)
          IF (FoundError(status, nf90_noerr, 5972,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_put_svar")) THEN
            WRITE (stdout,20) TRIM(myVarName), TRIM(ncname),            &
     &                        TRIM(SourceFile)
...
!
        IF (exit_flag.eq.NoError) THEN
          ...
          IF (FoundError(status, nf90_noerr, 6141,                      &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_close")) THEN
...
!
      ...
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6250,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_create")) THEN
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6337,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_enddef")) THEN
      ...
      SELECT CASE (omode)
        CASE (0)
          IF (InpThread) THEN
            ...
            IF (FoundError(status, nf90_noerr, 6434,                    &
     &                   "ROMS/Modules/mod_netcdf.F" //                 &
     &                   ", netcdf_open")) THEN
              IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
              PRINT *, trim(nf90_strerror(status))
        ...
        CASE (1)
          IF (OutThread) THEN
            ...
            IF (FoundError(status, nf90_noerr, 6462,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_open")) THEN
              IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
              PRINT *, trim(nf90_strerror(status))
        ...
        CASE DEFAULT
          IF (InpThread) THEN
            status=nf90_open(TRIM(ncname), nf90_nowrite, ncid)
            IF (FoundError(status, nf90_noerr, 6490,                    &
     &                     "ROMS/Modules/mod_netcdf.F" //               &
     &                     ", netcdf_open")) THEN
              IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
              PRINT *, trim(nf90_strerror(status))
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6585,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_redef")) THEN
          IF (Master) WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          PRINT *, trim(nf90_strerror(status))
...
!
      IF (OutThread) THEN
        ...
        IF (FoundError(status, nf90_noerr, 6662,                        &
     &                 "ROMS/Modules/mod_netcdf.F" //                   &
     &                 ", netcdf_sync")) THEN
          WRITE (stdout,10) TRIM(ncname), TRIM(SourceFile)
          PRINT *, trim(nf90_strerror(status))
